...
def add_force_arrow(viewer, start, force_world, scale=0.18, radius=0.0015,
                    rgba=(1.0, 0.2, 0.2, 0.9), max_len=0.35, min_len=0.03):
    ...
    if vec_norm < min_len:
        vec = vec / (vec_norm + 1e-12) * min_len
    elif vec_norm > max_len:
